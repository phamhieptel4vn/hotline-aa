import { c as create_ssr_component, a as subscribe, v as validate_component, h as escape, i as each, g as add_attribute, b as compute_rest_props, j as createEventDispatcher, m as missing_component, d as spread, e as escape_object, f as escape_attribute_value, o as onDestroy, n as compute_slots } from './index-288b18f9.js';
import { c as apiDeleteCampaign, d as apiPostCampaignRun, a as apiGetCampaigns } from './campaign-331a29ce.js';
import 'query-string';
...
import { n as notifySuccess, a as notifyApiError, M as Modal, b as ModalBody, c as ModalFooter, p as paginate, I as InlineContainer, P as Portal } from './paginate-393ff22a.js';
import { b as browserEvent, c as classnames } from './Offcanvas.svelte_svelte_type_style_lang-273b5b4d.js';
                  ...
                  return `${validate_component(Row, "Row").$$render($$result, {}, {}, {
                    default: () => {
                      return `${validate_component(Col, "Col").$$render($$result, { lg: "12 bg-primary p-3" }, {}, {
                        default: () => {
                          return `<h6 class="text-white mb-0 fw-bold">${escape($_("common.add_new"))} ${escape($_("common.campaign"))}</h6>
					
					<small class="text-white mb-0">${escape($_("common.add_new"))} ${escape($_("common.campaign"))}</small>`;
                        }
                      })}
                                    ...
                                    default: () => {
                                      return `${validate_component(Input, "Input").$$render(
                                        $$result,
                                        {
                                          type: "text",
                                          id: "campaignName",
                                          invalid: campaign.campaign_name.length < 5,
                            ...
                            default: () => {
                              return `${validate_component(Row, "Row").$$render($$result, { class: "g-3 align-items-center mb-3" }, {}, {
                                default: () => {
                                  return `${validate_component(Col, "Col").$$render($$result, { lg: "4" }, {}, {
                                    default: () => {
                                      return `${validate_component(Label, "Label").$$render($$result, { for: "ccu", class: "float-end fs-6" }, {}, {
                                        default: () => {
                            ...
                            default: () => {
                              return `${validate_component(Row, "Row").$$render($$result, { class: "g-3 align-items-center mb-3" }, {}, {
                                default: () => {
                                  return `${validate_component(Col, "Col").$$render($$result, { lg: "4" }, {}, {
                                    default: () => {
                                      return `${validate_component(Label, "Label").$$render($$result, { for: "calleeId", class: "float-end fs-6" }, {}, {
                                        default: () => {
                            ...
                            default: () => {
                              return `${validate_component(Row, "Row").$$render($$result, { class: "g-3 align-items-center mb-3" }, {}, {
                                default: () => {
                                  return `${validate_component(Col, "Col").$$render($$result, { lg: "4" }, {}, {
                                    default: () => {
                                      return `${validate_component(Label, "Label").$$render($$result, { for: "mode", class: "float-end fs-6" }, {}, {
                                        default: () => {
...
const Component = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const registerPlugin2 = registerPlugin;
  ...
  if ($$props.registerPlugin === void 0 && $$bindings.registerPlugin && registerPlugin2 !== void 0)
    $$bindings.registerPlugin(registerPlugin2);
...
<div class="filepond--wrapper"><input type="file"${add_attribute("id", id, 0)}${add_attribute("name", name, 0)}${add_attribute("class", klass, 0)}${add_attribute("accept", acceptedFileTypes, 0)} ${allowMultiple ? "multiple" : ""} ${required ? "required" : ""}${add_attribute("capture", captureMethod, 0)}></div>`;
});
const css = {
  code: "@import 'filepond/dist/filepond.css';@import '$lib/css/custom_form.css';.contact-info{font-size:0.8rem}.offcanvas-btn-close{left:-60px;top:15px;visibility:visible}.offcanvas .offcanvas-header{padding:0.5rem 0.75rem;width:100%}.offcanvas .offcanvas-header .offcanvas-title{width:100%}.offcanvas .offcanvas-body{padding:0rem 1.5rem}",
  map: null
};
const OffsetRunCampaign = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $_, $$unsubscribe__;
  $$unsubscribe__ = subscribe($format, (value) => $_ = value);
  ...
  if ($$props.isOpen === void 0 && $$bindings.isOpen && isOpen !== void 0)
    $$bindings.isOpen(isOpen);
  if ($$props.onSuccess === void 0 && $$bindings.onSuccess && onSuccess !== void 0)
    $$bindings.onSuccess(onSuccess);
  if ($$props.setLists === void 0 && $$bindings.setLists && setLists !== void 0)
    $$bindings.setLists(setLists);
  if ($$props.setCampaign === void 0 && $$bindings.setCampaign && setCampaign !== void 0)
    $$bindings.setCampaign(setCampaign);
  $$result.css.add(css);
  let $$settled;
  let $$rendered;
  do {
    $$settled = true;
    $$rendered = `${validate_component(Offcanvas, "Offcanvas").$$render(
      $$result,
      {
        scroll: true,
        isOpen,
      ...
      {
        header: () => {
          return `<div slot="header"><div class="offcanvas-btn-close position-absolute" ${!isOpen ? "hidden" : ""}>${validate_component(Button, "Button").$$render(
            $$result,
            {
              type: "button",
              color: "light",
            ...
            {
              default: () => {
                return `<i class="ni ni-cross-circle-fill ti-xl"></i>`;
              }
            }
          )}</div>
		${validate_component(Button, "Button").$$render(
            $$result,
            {
              type: "button",
              color: "transparent",
              class: "me-2 fw-semibold fs-5"
            },
            {},
            {
              default: () => {
                return `Run ${escape($_("common.campaign"))}`;
              }
            }
          )}</div>`;
        },
        default: () => {
          return `${validate_component(Card, "Card").$$render($$result, { class: "rounded border-0 mb-3" }, {}, {
            default: () => {
              return `${validate_component(CardBody, "CardBody").$$render($$result, { class: "py-2 contactForm" }, {}, {
                default: () => {
                  return `${validate_component(Row, "Row").$$render($$result, { class: "mt-3" }, {}, {
                    default: () => {
                      return `<p class="card-heading fw-bold fs-6">${escape($_("common.campaign"))} : ${escape(campaign.campaign_name)}</p>`;
                    }
                  })}
			${validate_component(Row, "Row").$$render($$result, { class: "mb-2" }, {}, {
                    default: () => {
                      return `<p>Choose one option to run this campaign:</p>`;
                    }
                  })}
			${validate_component(FormGroup, "FormGroup").$$render($$result, { class: "customForm" }, {}, {
                    default: () => {
                      return `${validate_component(Label, "Label").$$render($$result, { for: "campaignRunType" }, {}, {
                        default: () => {
                          return `Run:`;
                        }
                      })}
				${validate_component(Input, "Input").$$render(
                        ...
                        {
                          default: () => {
                            return `<option value="run-without-list">Start Campaign Only</option>
			...
			<form method="post" action="#">${runMethod == "choose-list" ? `${validate_component(FormGroup, "FormGroup").$$render($$result, { class: "customForm" }, {}, {
                    default: () => {
                      return `${validate_component(Label, "Label").$$render($$result, { for: "campaignRunType" }, {}, {
                        default: () => {
                          return `${escape($_("list"))}:`;
                        }
                      })}
						${validate_component(Input, "Input").$$render(
                        $$result,
                        ...
                        {
                          default: () => {
                            return `${lists.length < 1 ? `<option value="">Please upload a list</option>` : `<option value="">Please choose a list</option>
								${each(lists, (list) => {
                              return `<option${add_attribute("value", list.list_uuid, 0)}>${escape(list.list_name)}</option>`;
                            })}`}`;
                          }
                        }
                      )}`;
					...
					${validate_component(FormGroup, "FormGroup").$$render($$result, { class: "customForm" }, {}, {
                    default: () => {
                      return `${validate_component(Label, "Label").$$render($$result, { for: "fileImport" }, {}, {
                        default: () => {
                          return `${escape($_("file"))}`;
                        }
                      })}
						${validate_component(Component, "FilePond").$$render(
                        $$result,
                        {
                          name: "fileImport",
                          allowMultiple: false,
				...
				${validate_component(Row, "Row").$$render($$result, { class: "text-center" }, {}, {
                    default: () => {
                      return `${validate_component(Col, "Col").$$render($$result, { class: "m-auto" }, {}, {
                        default: () => {
                          return `${validate_component(Button, "Button").$$render($$result, { type: "button", color: "success" }, {}, {
                            default: () => {
                              return `${escape($_("submit"))}`;
                            }
                          })}
						${validate_component(Button, "Button").$$render($$result, { type: "button", color: "light" }, {}, {
                            default: () => {
                              return `${escape($_("close"))}`;
                            }
                          })}`;
                        }
                      })}`;
...
const TableCampaign = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let items;
  let totalItems;
  let paginatedItems;
  let $_, $$unsubscribe__;
  ...
  $$unsubscribe__();
  return `<div class="table-custom"><div class="table-responsive"><table class="table table-sm"><thead><tr><th class="fw-semibold" style="width: 20%;">${escape($_("campaign.campaign_name"))}</th>
					<th class="fw-semibold">${escape($_("campaign.mode"))}</th>
					<th class="fw-semibold">${escape($_("campaign.callee_id"))}</th>
					<th class="fw-semibold">${escape($_("campaign.ccu"))}</th>
					<th class="fw-semibold">${escape($_("campaign.gateway_id"))}</th>
					
					<th class="fw-semibold">${escape($_("campaign.group_cid_name"))}</th>
					<th class="fw-semibold">${escape($_("campaign.enable"))}</th>
					<th class="fw-semibold" style="width: 15%;">${escape($_("common.action"))}</th></tr></thead>
			<tbody>${data?.length > 0 ? `${each(paginatedItems, (row, i) => {
    return `<tr><td><strong>${escape(row.campaign_name)}</strong></td>
							<td><strong>${escape(row.mode)}</strong></td>
							<td><strong>${escape(row.callee_id)}</strong></td>
							<td><strong>${escape(row.ccu)}</strong></td>
							<td><strong>${escape(row.gateway_id)}</strong></td>
							
							<td><strong>${escape(row.group_cid_name)}</strong></td>
							<td><strong class="text-success">${escape(upperCase(row.is_enabled))}</strong></td>
							<td class="btn-group" role="group"><div class="d-flex justify-content-center"><a class="btn btn-icon btn-soft btn-outline-primary btnDetail"${add_attribute("href", `/campaign/${row.id}`, 0)}><i class="uil uil-edit mx-auto"></i></a>
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const handleDeleteCampaign = async (campaign) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        await apiDeleteCampaign(campaign.id, token).then(async (result2) => {
          if (result2.ok) {
  ...
  const handleRunCampaign = async (campaign, action) => {
    ...
    if (action == "start") {
      let lists = [];
      await apiGetLists(99, 0, { campaign_uuid: id }, token).then(async (result) => {
        if (result.ok) {
          let { data: data2 } = await result.json();
          lists = data2 ?? [];
        } else {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          await apiPostCampaignRun(id, action, token).then(async (result2) => {
            if (result2.ok) {
                  ...
                  default: () => {
                    return `${validate_component(TabContent, "TabContent").$$render($$result, { class: "nav-fill", pills: true }, {}, {
                      default: () => {
                                  ...
                                  return `${validate_component(Col, "Col").$$render($$result, { lg: "6" }, {}, {
                                    default: () => {
                                      return `${validate_component(CardTitle, "CardTitle").$$render(
                                        $$result,
                                        {
                                          title: $_("common.campaign_management"),
                                          icon: "ti ti-rocket"
                                        },
                                        {},
                                        {}
						...
						${validate_component(TableCampaign, "TableCampaign").$$render(
                                $$result,
                                {
                                  data: campaigns,
                                  handleDelete: handleDeleteCampaign,
                                  handleRun: handleRunCampaign
                                },
                                {},
                                {}
                              )}`;
...
${validate_component(OffsetRunCampaign, "OffsetRunCampaign").$$render(
      $$result,
      {
        token,
        onSuccess: () => {
        ...
        isOpen: offsetRunCampaignOpen,
        this: offsetRunCampaign
      },
      {
        isOpen: ($$value) => {
          offsetRunCampaignOpen = $$value;
          $$settled = false;
        },
        this: ($$value) => {
          offsetRunCampaign = $$value;
          $$settled = false;
        }
      },
      {}
...
${validate_component(AddModal, "AddModal").$$render(
      $$result,
      {
        data,
        token,
        isOpen: modalAddCampaignOpen
      },
      {
        isOpen: ($$value) => {
          modalAddCampaignOpen = $$value;
          $$settled = false;
        }
      },
      {}
...
//# sourceMappingURL=_page.svelte-41a3d17a.js.map
